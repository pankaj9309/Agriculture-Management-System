        ...
        <div class="container-fluid">
            ...
            <table class="table table-hover table-bordered" style="border:4px ridge">
                ...
                <tr>
                  ...
                  <% ResultSet rs = (ResultSet) request.getAttribute("salesdata");
                    while ( rs.next()){ %>
                    <tr>
                    ...
                    <td><a href='accept.jsp?prod=<%= rs.getString(2)%>&quality=<%= rs.getString(3)%>&quantity=<%= rs.getString(4)%>&marketprice=<%= rs.getString(5)%>'>accept</a> <a href='decline.jsp?prod=<%= rs.getString(2)%>&quality=<%= rs.getString(3)%>'>decline</a>
                    </tr>
                     <%}%>
            </table>
          </body>
