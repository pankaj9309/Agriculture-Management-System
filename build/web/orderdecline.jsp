...
<html>
    ...
    <body>
         <%  
                    ...
                    dbcon.updateTableUsingParameter("update orders set status='rejected' where produce_name=? and quality=?", productName, quality);
                    
                %>
                 <script type='text/javascript'>alert("Order Rejected") 
                            	window.back(); </script>
