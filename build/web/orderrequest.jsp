            ...
            <table class="table table-hover table-bordered" style="border:4px ridge">
                ...
                <tr>
                  ...
                  <% ResultSet rs = (ResultSet) request.getAttribute("orderdata");
                    ...
                    <td><a href='orderaccept.jsp?prod=<%= rs.getString(2)%>&quality=<%= rs.getString(3)%>&quantity=<%= rs.getString(4)%>'>accept</a> <a href='orderdecline.jsp?prod=<%= rs.getString(2)%>&quality=<%= rs.getString(3)%>'>decline</a>
                    </tr>
                     <%}%>
            </table>
          </body>
