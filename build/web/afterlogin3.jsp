                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-3">
                            <div class="thumbnail">
                             <img src="images/Grains/wheat.jpg" class="img-thumbnail" alt="Image"> 
                              <div class="caption">
                                <h3>Wheat</h3>
                                <p><a href="updateproduce.jsp?prod=Wheat" class="btn btn-primary" role="button" name="Wheat">View</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Bajara</h3>
                                <p><a href="updateproduce.jsp?prod=Bajara" class="btn btn-primary" role="button" >View</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Rice</h3>
                            <p><a href="updateproduce.jsp?prod=Rice" class="btn btn-primary" role="button">View</a> 
                          </div>
                        </div>
                        </div> 
                ...
                <div class="row">       
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Makka</h3>
                                <p><a href="updateproduce.jsp?prod=Makka" class="btn btn-primary" role="button">View</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Jawar</h3>
                                <p><a href="updateproduce.jsp?prod=Jawar" class="btn btn-primary" role="button">View</a> 
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-1 col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Matar</h3>
                            <p><a href="updateproduce.jsp?prod=Matar" class="btn btn-primary" role="button">View</a> 
                          </div>
                        </div>
                     </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-3">
                            <div class="thumbnail">
                             <img src="images/vegetables/onion.jpg" class="img-thumbnail" alt="Image"> 
                              <div class="caption">
                                <h3>Onion</h3>
                                <p><a href="updateproduce.jsp?prod=Onion" class="btn btn-primary" role="button">View</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Chilly</h3>
                                <p><a href="updateproduce.jsp?prod=Chilly" class="btn btn-primary" role="button">View</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Brinjal</h3>
                            <p><a href="updateproduce.jsp?prod=Brinjal" class="btn btn-primary" role="button">View</a> 
                          </div>
                        </div>
                        </div> 
                        ...
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Carrot</h3>
                            <p><a href="updateproduce.jsp?prod=Carrot" class="btn btn-primary" role="button">View</a> 
                          </div>
                        </div>
                        </div> 
                ...
                <div class="row">       
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Lady Finger</h3>
                                <p><a href="updateproduce.jsp?prod=Lady Finger" class="btn btn-primary" role="button">View</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Potato</h3>
                                <p><a href="updateproduce.jsp?prod=Potato" class="btn btn-primary" role="button">View</a> 
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-1 col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Tomato</h3>
                            <p><a href="updateproduce.jsp?prod=Tomato" class="btn btn-primary" role="button">View</a> 
                          </div>
                        </div>
                     </div>
                    ...
                    <div class="col-sm-1 col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>White Carrot</h3>
                            <p><a href="updateproduce.jsp?prod=White Carrot" class="btn btn-primary" role="button">View</a> 
                          </div>
                        </div>
                     </div>
