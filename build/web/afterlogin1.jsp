<%-- 
    Document   : afterlogin1
    Created on : Feb 12, 2023, 12:14:02 AM
    Author     : 91930
--%>
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-3">
                            <div class="thumbnail">
                             <img src="images/Grains/wheat.jpg" class="img-thumbnail" alt="Image"> 
                              <div class="caption">
                                <h3>Wheat</h3>
                                <p><a href="availableproduce.jsp?prod=Wheat" class="btn btn-primary" role="button" name="Wheat">Check Availability </a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Bajara</h3>
                                <p><a href="availableproduce.jsp?prod=Bajara" class="btn btn-primary" role="button" >Check Availability</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Rice</h3>
                            <p><a href="availableproduce.jsp?prod=Rice" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                        </div> 
                ...
                <div class="row">       
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Makka</h3>
                                <p><a href="availableproduce.jsp?prod=Makka" class="btn btn-primary" role="button">Check Availability</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Jawar</h3>
                                <p><a href="availableproduce.jsp?prod=Jawar" class="btn btn-primary" role="button">Check Availability</a> 
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-1 col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Matar</h3>
                            <p><a href="availableproduce.jsp?prod=Matar" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                     </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-3">
                            <div class="thumbnail">
                             <img src="images/vegetables/onion.jpg" class="img-thumbnail" alt="Image"> 
                              <div class="caption">
                                <h3>Onion</h3>
                                <p><a href="availableproduce.jsp?prod=Onion" class="btn btn-primary" role="button">Check Availability</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Chilly</h3>
                                <p><a href="availableproduce.jsp?prod=Chilly" class="btn btn-primary" role="button">Check Availability</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Brinjal</h3>
                            <p><a href="availableproduce.jsp?prod=Brinjal" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                        </div> 
                        ...
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Carrot</h3>
                            <p><a href="availableproduce.jsp?prod=Carrot" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                        </div> 
                ...
                <div class="row">       
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Lady Finger</h3>
                                <p><a href="availableproduce.jsp?prod=Lady Finger" class="btn btn-primary" role="button">Check Availability</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Potato</h3>
                                <p><a href="availableproduce.jsp?prod=Potato" class="btn btn-primary" role="button">Check Availability</a> 
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-1 col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Tomato</h3>
                            <p><a href="availableproduce.jsp?prod=Tomato" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                     </div>
                    ...
                    <div class="col-sm-1 col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>White Carrot</h3>
                            <p><a href="availableproduce.jsp?prod=White Carrot" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                     </div>
